...
bathy.params = params;
bathy.params.fB = [0.1,0.12,0.14,0.16,0.18,0.2,0.22,0.24];
%bathy.params.fB = bathy.params.fB(2:10);
bathy.params.maxNPix = 40;

bathy = analyzeBathyCollect(XYZ, T(1:90), RAW(1:90,:), CAM, bathy);
